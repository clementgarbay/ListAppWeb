  ...
  render() {
    return (
      <div className="checkbox-component">
        ...
        <svg className={classNames('checkbox-component-icon', {'checkbox-component-icon--animate': this.withAnimation})} viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
